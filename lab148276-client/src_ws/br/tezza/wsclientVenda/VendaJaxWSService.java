 ...
 * 
 */
@WebServiceClient(name = "VendaJaxWSService", targetNamespace = "http://jaxWS.tezza.br/", wsdlLocation = "http://localhost:8081/lab148276/VendaJaxWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName VENDAJAXWSSERVICE_QNAME = new QName("http://jaxWS.tezza.br/", "VendaJaxWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/lab148276/VendaJaxWS?wsdl");
    ...
    public VendaJaxWS getVendaJaxWSPort() {
        return super.getPort(new QName("http://jaxWS.tezza.br/", "VendaJaxWSPort"), VendaJaxWS.class);
    }
    ...
    public VendaJaxWS getVendaJaxWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxWS.tezza.br/", "VendaJaxWSPort"), VendaJaxWS.class, features);
    }
